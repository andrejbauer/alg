...
let rec _menhir_goto_plain_relation : _menhir_env -> 'ttv_tail -> _menhir_state -> (Input.formula') -> Lexing.position -> Lexing.position -> 'ttv_return =
...
and _menhir_goto_plain_quantified_formula : _menhir_env -> 'ttv_tail -> _menhir_state -> (Input.formula') -> Lexing.position -> Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v _startpos _endpos ->
    ...
    | MenhirState54 | MenhirState107 | MenhirState91 ->
        ...
        | _ ->
            _menhir_fail ())
    | MenhirState176 | MenhirState167 | MenhirState17 | MenhirState116 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let f = _v in
        let _startpos_f_ = _startpos in
...
and _menhir_reduce20 : _menhir_env -> 'ttv_tail * _menhir_state * (Input.term') * Lexing.position * Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack ->
    ...
    | MenhirState27 ->
        ...
        | INFIXOP4 _v ->
            _menhir_run27 _menhir_env (Obj.magic _menhir_stack) _v _menhir_env._menhir_endp
        | AND | COMMA | DOT | EOF | EQUAL | IFF | IMPLY | INFIXOP0 _ | INFIXOP1 _ | INFIXOP2 _ | INFIXOP3 _ | NOTEQUAL | OR | RPAREN ->
    ...
    | MenhirState34 ->
        ...
        | INFIXOP4 _v ->
            _menhir_run27 _menhir_env (Obj.magic _menhir_stack) _v _menhir_env._menhir_endp
        | AND | COMMA | DOT | EOF | EQUAL | IFF | IMPLY | INFIXOP0 _ | INFIXOP1 _ | INFIXOP2 _ | NOTEQUAL | OR | RPAREN ->
    ...
    | MenhirState36 ->
        ...
        | INFIXOP4 _v ->
            _menhir_run27 _menhir_env (Obj.magic _menhir_stack) _v _menhir_env._menhir_endp
        | AND | COMMA | DOT | EOF | EQUAL | IFF | IMPLY | INFIXOP0 _ | NOTEQUAL | OR | RPAREN ->
    ...
    | MenhirState20 ->
        ...
        | _ ->
            ...
            let (_menhir_stack, _menhir_s, _, _, _) = _menhir_stack in
            _menhir_errorcase _menhir_env (Obj.magic _menhir_stack) _menhir_s)
    | MenhirState176 | MenhirState167 | MenhirState17 | MenhirState54 | MenhirState57 | MenhirState138 | MenhirState136 | MenhirState131 | MenhirState132 | MenhirState122 | MenhirState116 | MenhirState107 | MenhirState91 | MenhirState61 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        assert (Pervasives.(<>) _menhir_env._menhir_shifted (-1));
        let _tok = _menhir_env._menhir_token in
        (match _tok with
...
and _menhir_goto_plain_formula : _menhir_env -> 'ttv_tail -> _menhir_state -> (Input.formula') -> Lexing.position -> Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v _startpos _endpos ->
    ...
    | MenhirState116 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let ((_menhir_stack, _menhir_s, f1, _startpos_f1_, _endpos_f1_), _, f2, _endpos_f2_) = _menhir_stack in
        let _startpos = _startpos_f1_ in
        let _endpos = _endpos_f2_ in
    ...
    | MenhirState17 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let (((_menhir_stack, _menhir_s, _startpos__1_), _, n), _, a, _endpos_a_) = _menhir_stack in
        let _startpos = _startpos__1_ in
    ...
    | MenhirState176 ->
        ...
        | EOF ->
            let _menhir_stack = Obj.magic _menhir_stack in
            let _menhir_stack = Obj.magic _menhir_stack in
            let (_menhir_stack, _menhir_s, f, _endpos_f_) = _menhir_stack in
            let _v : (Input.formula) =                     ( f ) in
            let _menhir_stack = Obj.magic _menhir_stack in
            let _menhir_stack = Obj.magic _menhir_stack in
            let _1 = _v in
  ...
  fun _menhir_env _menhir_stack ->
    ...
    | MenhirState91 ->
        ...
        | _ ->
            ...
            let (_menhir_stack, _menhir_s, _, _, _) = _menhir_stack in
            _menhir_errorcase _menhir_env (Obj.magic _menhir_stack) _menhir_s)
    | MenhirState176 | MenhirState167 | MenhirState17 | MenhirState57 | MenhirState61 | MenhirState116 | MenhirState122 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        assert (Pervasives.(<>) _menhir_env._menhir_shifted (-1));
        let _tok = _menhir_env._menhir_token in
        (match _tok with
...
and _menhir_goto_plain_or_formula : _menhir_env -> 'ttv_tail -> _menhir_state -> (Input.formula') -> Lexing.position -> Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v _startpos _endpos ->
    match _menhir_s with
    | MenhirState176 | MenhirState167 | MenhirState17 | MenhirState57 | MenhirState116 | MenhirState61 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let f = _v in
        let _startpos_f_ = _startpos in
...
and _menhir_goto_plain_and_formula_noquant : _menhir_env -> 'ttv_tail -> _menhir_state -> (Input.formula') -> Lexing.position -> Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v _startpos _endpos ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v, _startpos, _endpos) in
    match _menhir_s with
    | MenhirState176 | MenhirState167 | MenhirState17 | MenhirState57 | MenhirState131 | MenhirState122 | MenhirState116 | MenhirState61 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        assert (Pervasives.(<>) _menhir_env._menhir_shifted (-1));
        let _tok = _menhir_env._menhir_token in
        (match _tok with
        | DOT | EOF | IFF | IMPLY | OR ->
            let _menhir_stack = Obj.magic _menhir_stack in
...
and _menhir_goto_plain_and_formula : _menhir_env -> 'ttv_tail -> _menhir_state -> (Input.formula') -> Lexing.position -> Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v _startpos _endpos ->
    match _menhir_s with
    | MenhirState176 | MenhirState167 | MenhirState17 | MenhirState57 | MenhirState122 | MenhirState116 | MenhirState61 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let f = _v in
        let _startpos_f_ = _startpos in
...
and _menhir_goto_plain_negation_formula_noquant : _menhir_env -> 'ttv_tail -> _menhir_state -> (Input.formula') -> Lexing.position -> Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v _startpos _endpos ->
    match _menhir_s with
    | MenhirState176 | MenhirState167 | MenhirState17 | MenhirState57 | MenhirState136 | MenhirState131 | MenhirState122 | MenhirState116 | MenhirState91 | MenhirState61 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let f = _v in
        let _startpos_f_ = _startpos in
...
and _menhir_goto_plain_theory_entry : _menhir_env -> 'ttv_tail -> _menhir_state -> (Input.theory_entry') -> Lexing.position -> Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v _startpos _endpos ->
    ...
    | DOT ->
        ...
        | EOF ->
            _menhir_reduce7 _menhir_env (Obj.magic _menhir_stack) MenhirState170
        | _ ->
            assert (Pervasives.(<>) _menhir_env._menhir_shifted (-1));
            _menhir_env._menhir_shifted <- (-1);
...
and _menhir_goto_plain_negation_formula : _menhir_env -> 'ttv_tail -> _menhir_state -> (Input.formula') -> Lexing.position -> Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v _startpos _endpos ->
    match _menhir_s with
    | MenhirState176 | MenhirState167 | MenhirState17 | MenhirState57 | MenhirState122 | MenhirState116 | MenhirState91 | MenhirState61 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let f = _v in
        let _startpos_f_ = _startpos in
...
and _menhir_goto_plain_atomic_formula : _menhir_env -> 'ttv_tail -> _menhir_state -> (Input.formula') -> Lexing.position -> Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v _startpos _endpos ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v, _startpos, _endpos) in
    match _menhir_s with
    | MenhirState176 | MenhirState167 | MenhirState17 | MenhirState54 | MenhirState57 | MenhirState122 | MenhirState116 | MenhirState107 | MenhirState91 | MenhirState61 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        assert (Pervasives.(<>) _menhir_env._menhir_shifted (-1));
        let _tok = _menhir_env._menhir_token in
        (match _tok with
...
and _menhir_goto_option_theory_name_ : _menhir_env -> 'ttv_tail -> (Input.theory_name option) -> 'ttv_return =
  fun _menhir_env _menhir_stack _v ->
    ...
    | EOF ->
        _menhir_reduce7 _menhir_env (Obj.magic _menhir_stack) MenhirState6
    | _ ->
        assert (Pervasives.(<>) _menhir_env._menhir_shifted (-1));
        _menhir_env._menhir_shifted <- (-1);
...
and _menhir_run9 : _menhir_env -> 'ttv_tail -> _menhir_state -> (string) -> Lexing.position -> Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v _startpos _endpos ->
    ...
    | MenhirState97 | MenhirState99 | MenhirState75 | MenhirState73 | MenhirState71 | MenhirState69 | MenhirState67 | MenhirState65 | MenhirState63 | MenhirState19 | MenhirState20 | MenhirState25 | MenhirState40 | MenhirState38 | MenhirState36 | MenhirState34 | MenhirState32 | MenhirState27 | MenhirState21 ->
        ...
        | AND | COMMA | DOT | EOF | EQUAL | IFF | IMPLY | INFIXOP0 _ | INFIXOP1 _ | INFIXOP2 _ | INFIXOP3 _ | INFIXOP4 _ | NOTEQUAL | OR | RPAREN ->
    ...
    | MenhirState96 | MenhirState24 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        _menhir_reduce89 _menhir_env (Obj.magic _menhir_stack)
    | MenhirState176 | MenhirState167 | MenhirState17 | MenhirState54 | MenhirState57 | MenhirState61 | MenhirState131 | MenhirState138 | MenhirState136 | MenhirState132 | MenhirState116 | MenhirState122 | MenhirState107 | MenhirState91 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        assert (Pervasives.(<>) _menhir_env._menhir_shifted (-1));
        let _tok = _menhir_env._menhir_token in
        (match _tok with
...
and topformula : (Lexing.lexbuf -> token) -> Lexing.lexbuf -> (Input.formula) =
  fun lexer lexbuf ->
    let _menhir_env = _menhir_init lexer lexbuf in
    Obj.magic (let _menhir_stack = () in
    assert (Pervasives.(<>) _menhir_env._menhir_shifted (-1));
    ...
    | FALSE ->
        _menhir_run58 _menhir_env (Obj.magic _menhir_stack) MenhirState176 _menhir_env._menhir_startp _menhir_env._menhir_endp
    | FORALL ->
        _menhir_run55 _menhir_env (Obj.magic _menhir_stack) MenhirState176 _menhir_env._menhir_startp
    | IDENT _v ->
        _menhir_run9 _menhir_env (Obj.magic _menhir_stack) MenhirState176 _v _menhir_env._menhir_startp _menhir_env._menhir_endp
    | LPAREN ->
        _menhir_run20 _menhir_env (Obj.magic _menhir_stack) MenhirState176 _menhir_env._menhir_startp
    | NOT ->
        _menhir_run54 _menhir_env (Obj.magic _menhir_stack) MenhirState176 _menhir_env._menhir_startp
    | PREFIXOP _v ->
        _menhir_run19 _menhir_env (Obj.magic _menhir_stack) MenhirState176 _v _menhir_env._menhir_startp _menhir_env._menhir_endp
    | TRUE ->
        _menhir_run18 _menhir_env (Obj.magic _menhir_stack) MenhirState176 _menhir_env._menhir_startp _menhir_env._menhir_endp
    | _ ->
        assert (Pervasives.(<>) _menhir_env._menhir_shifted (-1));
        _menhir_env._menhir_shifted <- (-1);
